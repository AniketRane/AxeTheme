...
import Axenous from "./../assets/axenous.svg";
...
<template>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="/" class="flex ms-2 md:me-24">
                <!-- <img src="" class="h-8 me-3" alt="FlowBite Logo" /> -->
                 <Axenous class="text-green-400" height="20"/>
                <!-- <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Flowbite</span> -->
            </a>
            </div>
            <div class="flex items-center">
                <ax-toggle v-model="isThemeDark" label="Dark Mode"></ax-toggle>
    ...
    <div class="p-4 sm:ml-64 bg-[#f0f0f0] dark:bg-[#151d27] min-h-screen">
        <div class="mt-14">
            <router-view/>
        </div>
